    ...
    <div className="blueprint-grid min-h-screen pt-12 pb-24 relative z-10">
      ...
      <section className="py-20 border-t border-border bg-surface-2/30 relative overflow-hidden">
        ...
        <div className="max-w-[1400px] mx-auto px-6 md:px-12 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
          ...
          {/* Brand Card */}
          <div className="p-8 bg-surface border border-border rounded-none shadow-md hover:border-purple/30 transition-all duration-300">
            <div className="text-xs font-mono text-purple/60 mb-2">02 // IDENTITY</div>
            <h4 className="font-heading font-bold text-base text-primary mb-3">
              Brand
            </h4>
            <p className="text-secondary text-sm sm:text-base leading-relaxed font-normal">
          ...
          {/* Blok Card */}
          <div className="p-8 bg-surface border border-border rounded-none shadow-md hover:border-purple/30 transition-all duration-300">
            <div className="text-xs font-mono text-purple/60 mb-2">03 // FOUNDATION</div>
            <h4 className="font-heading font-bold text-base text-primary mb-3">
              Blok
            </h4>
            <p className="text-secondary text-sm sm:text-base leading-relaxed font-normal">
              A word meaning <strong className="text-primary font-semibold">"block"</strong> in Dutch, Polish, Czech, Croatian, and Slovenian. It represents a foundational piece forming a larger structure.
            </p>
          </div>
        </div>
